    ...
    <div>
      <div className="mx-10 mt-10">
        ...
        <div className="mb-4 border p-4 rounded-md">
          ...
          <p className="text-lg font-medium text-gray-700">
            Ans: Express.js is a lightweight web application framework for Node.js, offering flexibility and simplicity in building applications and APIs. It allows developers to define routes, middleware, and handlers according to their needs. Nest.js, on the other hand, is a scalable and opinionated framework for building server-side applications with Node.js. It leverages TypeScript and follows modular architecture principles, promoting code reusability and maintainability.
          </p>
        </div>
        <div className="mb-4 border p-4 rounded-md">
          <h1 className="text-2xl font-bold mb-2">
